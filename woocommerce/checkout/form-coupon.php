...
<div class="woocommerce-form-coupon-toggle">
    <?php wc_print_notice(apply_filters('woocommerce_checkout_coupon_message', esc_html__('Turite nuolaidos kuponą?', 'woocommerce') . ' <a href="#" class="showcoupon">' . esc_html__('Spauskite čia', 'woocommerce') . '</a>'), 'notice');?>
</div>
