                ...
                <div class="footer-section-content">
                    <ul>
                        ...
                        if (!empty($menu_nuorodos)) {
                            ...
                            <li><a href="<?php echo esc_url(get_post_type_archive_link('patarimai')); ?>">Naudingi
                                    Patarimai</a>
                            </li>
                            <?php
                        }
                ...
                <div class="footer-section-content">
                    <ul>
                        ...
                        if (!empty($menu_kategorijos)) {
                            ...
                            <li><a href="<?php echo esc_url(home_url('/product-category/namams')); ?>">Namams ir sau</a>
                            </li>
                            <li><a href="<?php echo esc_url(home_url('/product-category/automobiliai')); ?>">Automobilių
                                    priežiūrai</a></li>
                            <li><a href="<?php echo esc_url(home_url('/product-category/sodas')); ?>">Sodui ir daržui</a>
                            </li>
                            <?php
                        }
                        ?>
                ...
                <div class="footer-section-content">
                    <ul>
                        ...
                        if (!empty($menu_informacija)) {
                            ...
                            <li><a href="<?php echo esc_url(home_url('/prekiu-pirkimo-pardavimo-taisykles')); ?>">Prekių
                                    pirkimo
                                    - pardavimo taisyklės</a></li>
                            <li><a href="<?php echo esc_url(home_url('/pristatymas')); ?>">Prekių pristatymas ir
                                    atsiėmimas</a>
                            </li>
                            <li><a href="<?php echo esc_url(home_url('/garantija')); ?>">Garantinis aptarnavimas ir prekių
                                    grąžinimas</a></li>
                            <li><a
                                    href="<?php echo esc_url(get_privacy_policy_url() ?: home_url('/privatumo-politika')); ?>">Privatumo
                                    politika</a></li>
                            <?php
                        }
                        ?>
